    ...
    <div class="team-section">
        <div class="team-container" id="team-container">
            ...
            foreach ($teamMembers as $member) {
                ...
                echo '<img src="' . $member['img'] . '" alt="Team Member">';
                echo '<h3><i>' . $member['name'] . '</i></h3>';
                echo '<p>' . $member['role'] . '</p>';
                echo '<p>Age: ' . $member['age'] . '</p>';
                echo '<p>Hobby: ' . $member['hobby'] . '</p>';
                echo '<p>Zodiac Sign: ' . $member['zodiac'] . '</p>';
                echo '</div>';
            }
            ?>
